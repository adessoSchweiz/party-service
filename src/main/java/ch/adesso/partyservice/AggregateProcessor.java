...
public class AggregateProcessor implements Processor<String, EventEnvelope> {
	...
	Consumer<ProcessorEvent> eventConsumer;

	public AggregateProcessor(String partyStoreName, Consumer<ProcessorEvent> eventConsumer) {
	...
	public void process(String key, EventEnvelope value) {
		...
		eventConsumer.accept(new ProcessorEvent(root.getId(), root.getVersion()));
