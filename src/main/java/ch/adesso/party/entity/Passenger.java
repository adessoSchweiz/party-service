...
import ch.adesso.party.event.AddressCreatedEvent;
import ch.adesso.party.event.CreditCardChangedEvent;
import ch.adesso.party.event.CreditCardCreatedEvent;
...
public class Passenger extends AggregateRoot {
	...
	public JsonObject toJson() {
		return NullAwareJsonObjectBuilder.wrap(Json.createObjectBuilder()).add(JSON_KEYS.ID.getKeyName(), getId())
				.add(JSON_KEYS.VERSION.getKeyName(), getVersion()).add(JSON_KEYS.FIRSTNAME.getKeyName(), getFirstname())
